...
El nuevo sistema que planean implementar decidirá eficientemente quien califica para las becas. Normalmente, 
los estudiantes deben ayudar en clases de laboratorio y aprobar cuatro materias, con sus calificaciones
promedias para verificar eligibilidad.

las reglas de eligibilodad son: 

-Los estudiantes necesitan tener un promedio de calificaciones de 9 o más en todas las materias, sin ninguna
calificación individualk menor a 8, independientemente de como les fue como asistentes de laboratorio.

-Alternativamente, si tienen un promedio de 8.5 o más, aún pueden calificar si obtuvieron una calificación de "A" o "B" como 
asistente de laboratiorio.

-Sin embargo, si obtuvieron una calificación de "C" como asistentes de laboratorio, no calificarán para la beca, incluso 
...
function main() {
    ...
    const grade2 = parseFloat(prompt('Garde #2:'))
